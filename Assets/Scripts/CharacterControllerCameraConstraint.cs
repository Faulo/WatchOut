...
public class CharacterControllerCameraConstraint : MonoBehaviour {
    /// <summary>
    ...
    void SetCharacterHeight(float height) {
        ...
        _character.center = Vector3.up * height * 0.5f;
        //cameraRig.transform.localPosition = Vector3.up * height;
    }
}
